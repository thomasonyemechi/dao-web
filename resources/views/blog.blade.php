                            ...
                            <div class="single-item  wow fadeInUp animated animated animated animated animated"
                                ...
                                <div class="img-box">
                                    <a href="/blog/{{ $post->slug }}">
                                        <figure><img src="http://localhost/daodentals//{{ $post->image }}" alt=""></figure>
                                    </a>
                                </div>
                                <div class="lower-content">
                                    <ul class="meta">
                                        <li>Posted: <span> {{ $post->created_at }} </span></li>
                                        <li>Tags: <span> {{$post->tags}} </span></li>
                                    </ul>
                                    <div class="title"><a href="/blog/{{ $post->slug }}"> {{$post->title}} </a>
                                    </div>
                                    <div class="text">
                                        <p>
                                            {{ substr($post->body, 0, 2000) }}
                                        </p>
                                    </div>
                                    <div class="button">
                                        <a href="/blog/{{ $post->slug }}" class="btn-one style-one">read more</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget">
                            <div class="doctors-img centered">
                                <div class="img-box">
                                    <figure><img src="assets/images/service/d1.jpg" alt=""></figure>
                                </div>
